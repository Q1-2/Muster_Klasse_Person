...
int main() {
    ...
    person1.set_Alter(25); // Setze das Alter auf 25
    person1.ausgeben(); // Ausgabe der aktualisierten Personendaten

    person1.set_Alter(-10); // Versuch, das Alter auf einen ungültigen Wert zu setzen
    ...
    person2.set_Alter(30); // Setze das Alter auf 30
